...
<h1 align = center > Update Product </h1><hr> 
...
include 'server.php';
	...
	<td><center> <a href="u1.php?pid=<?php echo $menu['pid'];?>&category=men"> <img src="e1.png" width="40" height="50"> </a>
	    </center></td>
	<?php
	}
	?>
	...
	<td><?php echo $menu['seller']; ?> </td>
	<td><?php echo $menu['price']; ?> </td>
	<td><center> <a href="u1.php?pid=<?php echo $menu['pid'];?>&category=women"><img src="e1.png" width="40" height="50"></a>
	    </center></td>		
	<?php
	}
	?>
